...
Correr el comando `npm run build` y se creará la carpeta `/build` que es la que debés usar para deployar. 
Podés utilizar [gh-pages](https://npmjs.com/package/gh-pages) para hacer un deploy para testear.
